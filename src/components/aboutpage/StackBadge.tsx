export default function StackBadge({
  ...
  return (
    <div className="flex h-[calc(8rem+2px)] w-[calc(8rem+2px)] items-center justify-center rounded-md bg-gradient-to-br from-blue-500 to-purple-500 shadow-md md:h-[calc(10rem+4px)] md:w-[calc(10rem+4px)]">
